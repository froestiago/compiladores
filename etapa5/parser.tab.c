...
{
       0,    97,    97,    97,    99,   100,   102,   103,   104,   105,
     109,   109,   111,   118,   128,   136,   144,   146,   148,   149,
     151,   158,   160,   161,   163,   164,   166,   167,   169,   170,
     173,   174,   176,   177,   178,   179,   180,   181,   185,   188,
     198,   207,   216,   224,   231,   237,   238,   239,   241,   243,
     244,   246,   252,   258,   262,   269,   271,   278,   280,   287,
     294,   296,   303,   312,   321,   329,   331,   344,   351,   353,
     361,   369,   372,   374,   375,   376,   378,   387,   388,   389,
...
#line 1536 "parser.tab.c"
  ...
  case 5: /* program: list  */
#line 100 "parser.y"
               {(yyval.node) = (yyvsp[0].node); arvore = (yyval.node); imprime_lista();}
...
#line 262 "parser.y"
                ...
                current_temp++;
                Instruction *instruction = create_custom_instruction("or", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                }
...
#line 271 "parser.y"
                ...
                (yyval.node)->valor_lexico.temp = current_temp;
                current_temp++;
                Instruction *instruction = create_custom_instruction("and", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                }
...
#line 280 "parser.y"
                ...
                (yyval.node)->valor_lexico.temp = current_temp;
                current_temp++;
                Instruction *instruction = create_custom_instruction("cmp_EQ", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                }
...
#line 287 "parser.y"
                ...
                (yyval.node)->valor_lexico.temp = current_temp;
                current_temp++;
                Instruction *instruction = create_custom_instruction("cmp_NE", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                }
...
#line 296 "parser.y"
                ...
                (yyval.node)->valor_lexico.temp = current_temp;
                current_temp++;
                Instruction *instruction = create_custom_instruction("cmp_LT", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                }
...
#line 303 "parser.y"
                ...
                (yyval.node)->valor_lexico.temp = current_temp;
                current_temp++;
                Instruction *instruction = create_custom_instruction("cmp_GT", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                }
...
#line 312 "parser.y"
                ...
                (yyval.node)->valor_lexico.temp = current_temp;
                current_temp++;
                Instruction *instruction = create_custom_instruction("cmp_LE", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                }
...
#line 321 "parser.y"
                ...
                (yyval.node)->valor_lexico.temp = current_temp;
                current_temp++;
                Instruction *instruction = create_custom_instruction("cmp_GE", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                }
...
#line 331 "parser.y"
                        ...
                        (yyval.node)->valor_lexico.temp = current_temp;
                        current_temp++;
                        printf("-> %s + %s | ", (yyvsp[-2].node)->valor_lexico.valor, (yyvsp[0].node)->valor_lexico.valor);
                        
                        
                        Instruction *instruction = create_custom_instruction("add", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                        }
...
#line 344 "parser.y"
                        ...
                        (yyval.node)->valor_lexico.temp = current_temp;
                        current_temp++;
                        Instruction *instruction = create_custom_instruction("sub", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);}
...
#line 353 "parser.y"
                        ...
                        (yyval.node)->valor_lexico.temp = current_temp;
                        current_temp++;
                        Instruction *instruction = create_custom_instruction("mult", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                        }
...
#line 361 "parser.y"
                        ...
                        (yyval.node)->valor_lexico.temp = current_temp;
                        current_temp++;
                        Instruction *instruction = create_custom_instruction("div", (yyvsp[-2].node)->valor_lexico.temp, (yyvsp[0].node)->valor_lexico.temp, (yyval.node)->valor_lexico.temp);
                        }
